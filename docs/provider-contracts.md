...
| U-4a | 両社：送信した画像と生成物の保持期間。**Meshy の生成物は確認済み（最大3日・第2.6節）。Tripo は確認済み：保管義務が無く期間の定めも無い。ただし「公開」領域のものは永久保持されうる（第1.6.4節）**。残るのは「Meshy へ送信した画像の保持期間」 | 各社の規約 | 生徒作品を送る判断に必要 |
| U-4b | 両社：学習利用の可否と opt-out の手段。**Tripo は確認済み（第1.6.2節）：有料利用者の Inputs / Outputs は学習に使わないと明記。無料利用者は権利を会社が保持し、学習利用を妨げる条項が無い**。Meshy は未確認 | 各社の規約 | 同上。**Tripo は有料でなければ生徒作品を送れない** |
